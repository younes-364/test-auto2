...
inputs = {
  ...
  parameter_group = {
    data_disk_size            = 10
    instance_name             = "jboss-redhat7-${local.run_id}",
    provisioned_product_name  = "jboss-redhat7-${local.run_id}",
  ...
  custom_tags         = {
    ...
    "local.vmsource"           = "new"
    "axarole"                  = "jboss"
    "axa_jboss.state"          = "present"
    "axa_jboss.jboss_version"  = "7.4"
    "axa_jboss.Xmx"            = "1024"
    "axa_jboss.Xms"            = "1024"
    "axa_jboss.instances"      = "default"
    "axa_jboss.instance_users" = "jboss"
