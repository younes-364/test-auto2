...
inputs = {
  ...
  backup_plan      = "none"
  image_template   = "EC2MutableWin2016Sql"
  os_type          = "Windows"
  ...
  parameter_group = {
    sql_drive_size            = 30
    instance_name             = "T0070-${local.run_id}",
    provisioned_product_name  = "T0070-${local.run_id}",
  ...
  custom_tags         = {
    "local.purpose"                = "mpi"
    "local.vmsource"               = "new"
    "axa_sql.state"                = "present"
    "axa_sql.sql_version"          = "2019"
    "axa_sql.sql_edition"          = "ee"
    "axa_sql.sql_install_features" = "SQLDBEngine"
    "axa_sql.sql_collation_label"  = "Latin1_General_CI_AS"
  }
}
